    ...
    <center>
        <section>
            <div>
                ...
                $article1 = 'The Consumer Protection Act, 2019';
                echo "<div class='container'>";
                echo "<img src='img/road4.jpeg' width=50%  height=50%/>";

                if ($article1) {
                    $sql1 = "SELECT * FROM admin where article='The Consumer Protection Act, 2019 '";
