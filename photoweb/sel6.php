    ...
    <center>
        <section>
            <div>
                ...
                $background_color = "#efabdf";

                $article1 = 'The Central Motor Vehicles Rules, 1989';

                echo "<div class='container'>";
                echo "<img src='img/road1.jpeg' width=50%  height=50%/>";

                if ($article1) {
                    $sql1 = "SELECT * FROM admin where article='$article1'";
